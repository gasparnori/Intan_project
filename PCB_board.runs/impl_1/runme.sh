...
HD_PWD='E:/Nora/Xilinx/mux_adc_intan_simplified/PCB_board/PCB_board.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPI_counter.tcl -notrace
